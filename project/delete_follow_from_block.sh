...
curl -XPOST -H 'Content-Type: application/json' 'https://vpc-production1-new-node-js-d25dxb5wvxp5wwaih2qxwlqcve.us-west-2.es.amazonaws.com/trending/doc/_delete_by_query' -d '
{
  "query": {
    "bool": {
      "should": [
...
curl -XGET -H 'Content-Type: application/json' 'https://vpc-production1-new-node-js-d25dxb5wvxp5wwaih2qxwlqcve.us-west-2.es.amazonaws.com/trending/doc/_count?pretty' -d '
{
  "query": {
    "bool": {
      "should": [
